...
define('blog/index',["exports"], function (exports) {
    "use strict";
    ...
    var Blog = exports.Blog = function () {
        ...
        Blog.prototype.configureRouter = function configureRouter(config, router) {
            config.map();

            this.router = router;
        };

        Blog.prototype.loadArticles = function loadArticles() {};

        return Blog;
    }();
});
define('blog/article',["exports"], function (exports) {
    "use strict";
    ...
    var Article = exports.Article = function Article(data) {
...
define('blog/blog',["exports"], function (exports) {
    ...
    var Blog = exports.Blog = function () {
        ...
        Blog.prototype.activate = function activate(params) {
            var _this = this;

            this.loadArticle(params.slug).then(function (article) {
...
define('text!blog/index.html', ['module'], function(module) { module.exports = "<template><header><nav><span class=header-title>Blog</span></nav></header><section><rouer-view></rouer-view></section></template>"; });
