        ...
        App.prototype.attached = function attached() {
            ...
            target.onscroll = function (event) {
                ...
                while (view = _this.State.views[index++]) {
                    ...
                    var bottom = view.element.offsetTop + view.element.clientHeight;
                    var offset = view.element.offsetTop - scrollTop;
                    var backset = view.element.offsetTop + view.element.clientHeight - scrollTop;
