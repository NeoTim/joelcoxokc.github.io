...
define('modules/title/title',['exports'], function (exports) {
    ...
    var Title = exports.Title = function () {
        ...
        Title.prototype.showNativeAnimation = function showNativeAnimation() {
            var _this = this;
            ...
            animationstart = function animationstart(element, callback) {
            ...
            animationend = function animationend(element, callback) {
                var listener = function listener(event) {
                    event.dispose = function () {
            ...
            reset = function reset() {
                animationend(UX, function () {
                    UX.classList.remove('animate', 'animate-out');
                    _this.showNativeAnimation();
                });
            ...
            while (node = nodes.shift()) {
                append(node);
                if (!nodes.length) {
                    animationend(node, function (event) {
