...
define('core/color',['exports'], function (exports) {
    ...
    }, _class.blue = '#284B63', _class.teal = '#77A0A2', _class.white = '#FFFFFF', _class.tan = '#D9D9D9', _class.brown = '#353535', _class.light = {
...
define('resume/index',['exports', 'aurelia-framework', './title/title', './profile/profile', './projects/projects', './experience/experience', './education/education', './technology/technology', './connect/connect', 'core/enums', 'state', 'core/view', 'core/color'], function (exports, _aureliaFramework, _title, _profile, _projects, _experience, _education, _technology, _connect, _enums, _state, _view, _color) {
    'use strict';
    ...
    var Resume = exports.Resume = (_dec = (0, _aureliaFramework.inject)(_enums.Enums, _state.State, _aureliaFramework.Factory.of(_title.Title), _aureliaFramework.Factory.of(_profile.Profile), _aureliaFramework.Factory.of(_projects.Projects), _aureliaFramework.Factory.of(_experience.Experience), _aureliaFramework.Factory.of(_education.Education), _aureliaFramework.Factory.of(_technology.Technology), _aureliaFramework.Factory.of(_connect.Connect)), _dec(_class = function () {
        function Resume(Enums, State, Title, Profile, Projects, Experience, Education, Technology, Connect) {
...
define('core/enums/experience',['exports'], function (exports) {
    'use strict';
...
define('core/shade',['exports', './color'], function (exports, _color) {
    'use strict';

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.Shade = undefined;
    ...
    var Shade = exports.Shade = function Shade(color, options) {
        _classCallCheck(this, Shade);

        this.fill = color;

        if (_color.Color.isLight(this.fill)) {
            this.primary = _color.Color.light.primary;
            this.secondary = _color.Color.light.secondary;
            this.disabled = _color.Color.light.disabled;
            this.divider = _color.Color.light.divider;
        } else {
            this.primary = _color.Color.dark.primary;
            this.secondary = _color.Color.dark.secondary;
            this.disabled = _color.Color.dark.disabled;
            this.divider = _color.Color.dark.divider;
        }
    };
});
define('text!app.html', ['module'], function(module) { module.exports = "<template><require from=./app.css></require><div class=app-background></div><dialog-container></dialog-container><navigation instruction.bind=router.currentInstruction></navigation><container><compose containerless view-model.bind=header></compose><main><router-view></router-view></main><compose containerless view-model.bind=footer></compose></container><div class=background-container></div></template>"; });
...
define('text!resume/index.html', ['module'], function(module) { module.exports = "<template><template repeat.for=\"view of State.views\"><nav-section class=\"${$first ? 'first' : $last ? 'last' : ''} app-${view.name}\" view.bind=view></nav-section></template></template>"; });
